...
export default function StudentAttendance() {
  ...
  useEffect(() => {
    async function fetchAttendance() {
      try {
        ...
        // Assuming Aarav Sharma is STU-1001
        const studentId = "STU-1001";
        const myRecord = data.records.find(r => r.id === studentId);
  ...
  return (
    <div>
      <PageHeader
        title="My Attendance"
        description="View your daily attendance history and overall percentage."
